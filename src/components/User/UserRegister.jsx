...
const UserRegister = () => {
    ...
    const handleLogin = async (e) => {
        ...
        const apiEndpoint = `${process.env.REACT_APP_API_URL}/user/create`;
        ...
        try {
            ...
            if (error.response) {
                setError(`${error.response.data.message}, try with different username.` || "An error occurred during register.");
            ...
            <Paper elevation={6} sx={{ padding: 4, margin: 2 }}>
                ...
                <TextField
                    ...
                    <Button
                        ...
                        color="primary"
                        sx={{ mt: 0.5, mb: 2 }}
                        onClick={handleUserLoginButtonCLick}
                    >
